 ...
 * Get shoesmain
 */
exports.getShoesMain = function(req, res) {
  return ViewData.findOne({ 'data.key': 'Shoes Main' }).exec(function (err, header) {
    if (!err) {
      return res.json(header);
    } else {
      return res.send(err);
 ...
 * Get clothingmain
 */
exports.getClothingMain = function(req, res) {
  return ViewData.findOne({ 'data.key': 'Clothing Main' }).exec(function (err, header) {
    if (!err) {
      return res.json(header);
    } else {
      return res.send(err);
 ...
 * Get accessoriesmain
 */
exports.getAccessoriesMain = function(req, res) {
  return ViewData.findOne({ 'data.key': 'Accessories Main' }).exec(function (err, header) {
    if (!err) {
      return res.json(header);
    } else {
      return res.send(err);
 ...
 * Get menmain
 */
exports.getMenMain = function(req, res) {
  return ViewData.findOne({ 'data.key': 'Men Main' }).exec(function (err, header) {
    if (!err) {
      return res.json(header);
    } else {
      return res.send(err);
