...
}).directive('ajaxLoadCover', function(TransitionEndService) { // [data-ajax-load-cover]
	return {
		link: function(scope, element, attrs) {
...
}).directive('facetOptions', function($compile) { // [data-facet-options]
...
}).directive('facetReset', function($templateCache) { // [data-facet-reset]
	return {
		templateUrl: "listing-facet-reset-html"
	};
}).directive('facetToggleAll', function($templateCache) { // [data-facet-toggle-all]
	return {
...
}).directive('viewControls', function($templateCache) { // [data-view-controls]
	return {
		templateUrl: 'listing-view-controls-html'
	};
}).directive('listingProducts', function($templateCache) { // [data-listing-products]
	return {
...
}).directive('select', function($timeout) { // [data-select]
	return {
		link: function(scope, element, attrs) {
...
}).directive('selectUpdate', function($timeout) { // [data-select-update]
	return {
		link: function(scope, element, attrs) {
...
}).directive('quickShopPanel', function($document, $q, $rootScope, $timeout, QuickShopPanelService) { // [data-quick-shop-panel]
    return {
        restrict: 'A',
        link: function(scope, element, attr) {
...
}).directive('selectChanged', function($rootScope) {
...
}).directive('ngSelectRepeated', function($timeout) {
	return {
		restrict: 'A',
		link: function(scope, element, attrs) {
...
}]).directive('postcodeAnywhereNoresults', [ function($templateCache) { // [data-postcode-anywhere-noresults]
	return {
		templateUrl: "postcode-anywhere-noresults-html"
	};
}]).directive('postcodeAnywhereNoshipping', [ function($templateCache) { // [data-postcode-anywhere-noshipping]
	return {
